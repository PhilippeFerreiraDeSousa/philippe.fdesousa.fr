...
Project url is: https://philippeferreiradesousa.github.io.
...
* Launch `sh build.sh`, then configure a server to serve statically the folder */docs/_site* on the subdomain philippe.fdesousa.fr.
